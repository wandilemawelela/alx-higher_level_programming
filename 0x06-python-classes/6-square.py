...
The attribute position which takes a default (0, 0) tuple.
The methods Getter and Setter set properties for size and position.
The method area returns size of area of the square.
The method my_print prints the square using "#", moved over left and top using
position tuple.
"""
